# ================================================================
# 👑 AALM VASTRALAY — GEMINI & ANTIGRAVITY AGENT GUIDE
# ================================================================

You are Antigravity working on Aalm Vastralay (आलम वस्त्रालय).
...
5. REFER `docs/README.md` — Complete documentation hub & operational runbooks.
