...
export const SETTINGS_FIELDS: SettingField[] = [
  ...
  { key: "site.faviconEmoji", group: "brand", label: "Favicon emoji", type: "text", default: "👑" },
  {
    ...
    type: "list",
    default: "Royal Indian Wedding & Luxury Ethnic Wear|Exquisite Handcrafted Sarees, Lehengas & Sherwanis|Free Delivery Nationwide · Cash on Delivery Available|Proprietor: Suheb Alam · Kalyanipur · WhatsApp: 8434061342",
  ...
  { key: "security.botProtection", group: "security", label: "Bot protection", type: "select", options: ["pow", "off"], default: "pow", help: "Altcha-style proof-of-work: browsers must solve a hash puzzle before submitting forms. No third-party captcha, no API keys, works offline." },
  {
    ...
    group: "security",
    label: "Bot shield display mode (5 layouts)",
    type: "select",
    options: ["standard", "bar", "floating", "overlay", "invisible"],
    default: "standard",
    help: "Choose layout: standard (Turnstile card), bar (slim inline strip), floating (bottom-right pinned badge), overlay (security modal gate), or invisible (automatic background solving).",
  },
  {
