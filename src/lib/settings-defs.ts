...
export const SETTINGS_FIELDS: SettingField[] = [
  /* ---------------- brand ---------------- */
  { key: "site.name", group: "brand", label: "Site name", type: "text", default: "Aalm Wastralay" },
  { key: "site.tagline", group: "brand", label: "Tagline", type: "text", default: "बेहतरीन क्वालिटी, उचित मूल्य — आपकी पसंद, हमारी पहचान" },
  ...
  { key: "site.faviconEmoji", group: "brand", label: "Favicon emoji", type: "text", default: "👗" },
  {
    ...
    type: "list",
    default: "बेहतरीन क्वालिटी, उचित मूल्य — आपकी पसंद, हमारी पहचान|साड़ी, सूट, लहंगा एवं फैब्रिक्स का संपूर्ण कलेक्शन|हर अंदाज आपके लिए खास|Propriter: Suheb Alam · Kalyanipur · Call/WhatsApp: 8434061342",
  ...
  { key: "site.email", group: "brand", label: "Support email", type: "text", default: "support@aalmwastralay.in" },
  { key: "site.address", group: "brand", label: "Registered address", type: "textarea", default: "Kalyanipur, Bihar, India (Proprietor: Suheb Alam)" },
  { key: "site.copyright", group: "brand", label: "Footer copyright line", type: "text", default: "आलम वस्त्रालय (Aalm Wastralay) — स्टाइल भी आपका, भरोसा भी हमारा।" },
  ...
  { key: "home.bannerTitle", group: "home", label: "Banner headline", type: "text", default: "स्टाइल भी आपका, भरोसा भी हमारा — संपूर्ण वस्त्र एवं साड़ी संसार" },
  { key: "home.bannerSubtitle", group: "home", label: "Banner sub-headline", type: "textarea", default: "शानदार बनारसी, कांजीवरम व डिज़ाइनर साड़ियां, ब्राइडल लहंगा, सलवार सूट, कुर्ता व मेंस वियर। बेहतरीन क्वालिटी, उचित मूल्य — प्रो. सुहेब आलम (कल्याणपुर)।" },
  { key: "home.bannerCtaLabel", group: "home", label: "Primary button label", type: "text", default: "साड़ी व सूट कलेक्शन देखें" },
